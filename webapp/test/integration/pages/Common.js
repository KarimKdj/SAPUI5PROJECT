sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("sapui5/SAPUI5_FINAL/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#ProjectManagement-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#ProjectManagement-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("sapui5.SAPUI5_FINAL.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["sapui5/SAPUI5_FINAL/localService/mockserver"], function (mockserver) {

...
sap.ui.define([
	...
	return BaseController.extend("sapui5.SAPUI5_FINAL.controller.ProjectLid", {
		...
		onInit: function () {
			...
			this.getRouter().getRoute("projectlidObject").attachPatternMatched(this._onObjectMatched, this);
		...
		onDelete: function () {
			...
			var oViewModel = this.getModel("detailView"),
				...
				sObjectHeader = this._oODataModel.getProperty(sPath + "/Achternaam"),
		...
		_onObjectMatched: function (oEvent) {
			...
			this.getModel().metadataLoaded().then(function () {
				var sObjectPath = this.getModel().createKey("ProjectlidSet", oParameter);
		...
		_onBindingChange: function () {
			...
			var sPath = oElementBinding.getBoundContext().getPath(),
				...
				sObjectId = oObject.ProjectlidId,
				sObjectName = oObject.Achternaam;

sap.ui.define([
	...
	return BaseController.extend("sapui5.SAPUI5_FINAL.controller.CreateRolEntity", {
		...
		onInit: function () {
			var that = this;
			this.getRouter().getTargets().getTarget("createRol").attachDisplay(null, this._onDisplay, this);
		...
		_navBack: function () {
			...
			if (sPreviousHash !== undefined) {
				...
				this.getRouter().getTargets().display("rolObject");
			}
		},
		...
		_validateSaveEnablement: function () {
			var aInputControls = this._getFormFields(this.byId("newEntitySimpleFormRol"));
			var oControl;
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("RolSet", oData);

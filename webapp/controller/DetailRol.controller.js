...
sap.ui.define([
	...
	return BaseController.extend("sapui5.SAPUI5_FINAL.controller.DetailRol", {
		...
		onInit: function () {
			...
			this.getRouter().getRoute("rolObject").attachPatternMatched(this._onObjectMatched, this);
		...
		onDelete: function () {
			...
			var oViewModel = this.getModel("detailView"),
				...
				sObjectHeader = this._oODataModel.getProperty(sPath + "/Naam"),
		...
		_onObjectMatched: function (oEvent) {
			...
			this.getModel().metadataLoaded().then(function () {
				var sObjectPath = this.getModel().createKey("RolSet", oParameter);

...
sap.ui.define([
	...
	"sap/ui/Device",
	"sapui5/SAPUI5_FINAL/model/formatter",
	"sap/m/MessageBox",
	"sapui5/SAPUI5_FINAL/model/grouper",
	...
	return BaseController.extend("sapui5.SAPUI5_FINAL.controller.Master", {
		...
		onSearch: function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("Titel", FilterOperator.Contains, sQuery)];
			} else {
		...
		onOpenViewSettings: function () {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("sapui5.SAPUI5_FINAL.view.ViewSettingsDialog", this);
		...
		onConfirmViewSettingsDialog: function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
				case "Filter1":
					aFilters.push(new Filter("ProjectId", FilterOperator.LE, 100));
					break;
				case "Filter2":
					aFilters.push(new Filter("ProjectId", FilterOperator.GT, 100));
					break;
				default:
					break;
				}
